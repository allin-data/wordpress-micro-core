...
require jet_tricks()->plugin_path( 'includes/updater/base-update.php' );
 ...
 * @since 1.0.0
 */
class Jet_Tricks_Plugin_Update extends Jet_Tricks_Base_Update {
...
if ( ! function_exists( 'jet_tricks_updater' ) ) {
	function jet_tricks_updater() {
		return new Jet_Tricks_Plugin_Update();
	}
}
