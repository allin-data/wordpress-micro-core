...
require jet_blog()->plugin_path( 'includes/updater/class-jet-blog-base-update.php' );
 ...
 * @since 1.0.0
 */
class Jet_Blog_Plugin_Update extends Jet_Blog_Base_Update {
...
if ( ! function_exists( 'jet_blog_updater' ) ) {
	function jet_blog_updater() {
		return new Jet_Blog_Plugin_Update();
	}
}
