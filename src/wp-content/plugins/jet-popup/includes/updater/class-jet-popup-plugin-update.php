...
require jet_popup()->plugin_path( 'includes/updater/class-jet-popup-base-update.php' );
 ...
 * @since 1.0.0
 */
class Jet_Popup_Plugin_Update extends Jet_Popup_Base_Update {
...
if ( ! function_exists( 'jet_popup_updater' ) ) {
	function jet_popup_updater() {
		return new Jet_Popup_Plugin_Update();
	}
}
