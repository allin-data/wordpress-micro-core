...
require jet_blocks()->plugin_path( 'includes/updater/class-jet-blocks-base-update.php' );
 ...
 * @since 1.0.0
 */
class Jet_Blocks_Plugin_Update extends Jet_Blocks_Base_Update {
...
if ( ! function_exists( 'jet_blocks_updater' ) ) {
	function jet_blocks_updater() {
		return new Jet_Blocks_Plugin_Update();
	}
}
