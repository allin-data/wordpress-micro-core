...
if ( ! class_exists( 'Monstroid2_Module_Base' ) ) {

	/**
	 * Define Monstroid2_Module_Base class
	 */
	abstract class Monstroid2_Module_Base {
		...
		public function load_child_modules( $childs = array() ) {
			...
			foreach ( $childs as $child => $childs_of_child ) {
				monstroid2_theme()->load_module( $child, $childs_of_child );
			}
