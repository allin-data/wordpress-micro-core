...
if ( ! class_exists( 'Monstroid2_Woo_Page_Title_Module' ) ) {

	/**
	 * Define Monstroid2_Woo_Page_Title_Module class
	 */
	class Monstroid2_Woo_Page_Title_Module extends Monstroid2_Module_Base {
