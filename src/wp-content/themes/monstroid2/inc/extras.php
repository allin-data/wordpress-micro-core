 ...
 * Container type
 */
add_filter( 'theme_mod_container_type', 'monstroid2_set_post_meta_value' );

/**
 * Header layout type
 */
add_filter( 'theme_mod_header_layout_type', 'monstroid2_set_header_layout_value' );
 ...
 * @return string
 */
function monstroid2_set_header_layout_value( $value ) {

	if ( wp_is_mobile() ) {
		return 'mobile';
	}

	return monstroid2_set_post_meta_value( $value );
}
...
function monstroid2_get_queried_obj() {
	$queried_obj = apply_filters( 'monstroid2-theme/posts/queried_object_id', false );
...
function monstroid2_render_macros( $string ) {
	...
	$macros = apply_filters( 'monstroid2-theme/data_macros', array(
		'/%%year%%/' => date( 'Y' ),
...
function monstroid2_get_render_icons_set() {
	return apply_filters( 'monstroid2-theme/icons/icons-set', array(
 ...
 * @return string
 */
function monstroid2_justify_thumbnail_size( $mask = 0, $thumbnail_size = 'post-thumbnail', $justify_size='monstroid2-thumb-justify', $justify_size_1 = 'monstroid2-thumb-justify', $justify_size_2 = 'monstroid2-thumb-justify-2') {
	$mask_list = array(
...
function monstroid2_get_post_template_part_slug() {
	return apply_filters( 'monstroid2-theme/posts/template-part-slug', 'template-parts/content' );
}
 ...
 * @return string
 */
function monstroid2_get_post_style() {
	return apply_filters( 'monstroid2-theme/posts/post-style', false );
}
 ...
 * @return array
 */
function monstroid2_kses_post_allowed_html( $additional_allowed_html = array() ) {
